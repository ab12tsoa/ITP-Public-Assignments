...
//  myLines = loadStrings("/Users/allisonberman/Documents/Processing/HashMapClass_test/data/dracula.txt");
  myLines = loadStrings("/Users/allisonberman/Documents/Processing/joinemails/data/data.txt");
//  myLines = loadStrings("MobyDick.txt");
// for(int i = 0; i < 2430; i++){
// lines = loadStrings("/Users/allisonberman/Documents/myemails/email_" + i + ".eml");
// full = join(lines, " ");
// }
// 
//  println(full);
